...
1. Lisää oikea nimesi gihub profiiliin
1. Kuva olisi kiva
...
- Käydään läpi perusteet: `add`, `commit`, `push`, `log` ja `diff`

### Ryhmätyöskentely
- Tutustuaan GitHubiin
- Jakaudutaan pienryhmiin ja tutustutaan ryhmätyöskentelyn saloihin: `pull`, `rebase`, `merge` ja `fetch`
